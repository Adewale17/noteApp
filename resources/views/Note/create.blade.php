<x-app-layout>
  ...
  <div class="min-h-screen bg-gray-50 py-20 px-10">
    <div class="mx-auto w-full max-w-7xl bg-white shadow-xl rounded-3xl p-12 border border-gray-100">
      ...
      <div class="flex items-center justify-between mb-12">
        <h1 class="text-4xl font-bold text-gray-800 tracking-tight">Create New Note</h1>
      ...
      <!-- Form -->
      <form class="space-y-10" method="POST" action="{{ route('note.store') }}">
        @csrf
        <div>
  ...
  @enderror
        ...
        <div class="flex items-center justify-between pt-8 border-t border-gray-200">
          <a href="{{ route('note.index') }}" class="text-gray-500 hover:text-gray-700 hover:underline text-base font-medium">
            Cancel
          </a>
         <button
                    type="submit"
